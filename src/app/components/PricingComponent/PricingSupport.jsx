...
const PricingSupport = () => {
  return (
    <section className="p-4 md:p-10">
      <div className="max-w-[1050px] gap-3 mb-10 p-6 py-15 rounded-[20px] mx-auto bg-white flex flex-col md:flex-row items-center justify-between">
        <Image
        ...
        <div className="flex flex-col gap-3 md:order-2 order-1 ">
          ...
          <Link
            className="bg-[#713fff] w-full md:w-[80%] md:self-start self-center my-4 text-center text-white text-xl hover:opacity-80 rounded-full px-10 py-4"
